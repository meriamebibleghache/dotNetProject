<%@ Page Title="" Language="C#" MasterPageFile="~/UserScreen/User.Master" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="ApplicationBibliothequeProjet.UserScreen.UserHome" %>
    ...
    <div class="row">
        <div class="col-lg-4 mb-4">
            ...
            <div class="card h-100 border-start-lg border-start-primary">
                <div class="card-body">
                    <div class="small text-muted">Current Reservated Books</div>
                    <div class="h3"> <asp:Label ID="lblIssuebook" runat="server" Text="Label"></asp:Label></div>
                    <a class="text-arrow-icon small" href="ReservationDetails.aspx">
                        View All
